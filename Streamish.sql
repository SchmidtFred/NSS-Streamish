...
INSERT INTO [UserProfile]
    ([Id], [Name], [Email], [DateCreated], [ImageUrl], [FirebaseUserId])
VALUES
    (1, 'Groucho', 'groucho@marx.com', SYSDATETIME(), NULL, '0WQMDQq4SmXzv1oZD08T6ca2jpE3'),
    (2, 'Harpo', 'harpo@marx.com', SYSDATETIME(), NULL, '4Viypv3qQ9X1RJSl7M3469Yv4no2'),
    (3, 'Chico', 'chico@marx.com', SYSDATETIME(), NULL, 'aP709Zm1ZSZjRGCvNrqlcbho7Qc2');
